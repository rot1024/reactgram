...
var venderPrefix = typeof navigator === "undefined" ? "" : /webkit/i.test(navigator.appVersion) ? "-webkit-" : /firefox/i.test(navigator.userAgent) ? "-moz-" : /trident/i.test(navigator.userAgent) ? "-ms-" : "";

var lineGridStyle = function lineGridStyle(_ref) {
  var backgroundColor = _ref.backgroundColor,
      _ref$gridColor = _ref.gridColor,
      gridColor = _ref$gridColor === void 0 ? "rgba(255, 255, 255, .05)" : _ref$gridColor,
      _ref$gridSize = _ref.gridSize,
      gridSize = _ref$gridSize === void 0 ? 80 : _ref$gridSize;
  return {
...
var dotGridStyle = function dotGridStyle(_ref2) {
  var backgroundColor = _ref2.backgroundColor,
      _ref2$gridColor = _ref2.gridColor,
      gridColor = _ref2$gridColor === void 0 ? "rgba(255, 255, 255, .2)" : _ref2$gridColor,
      _ref2$gridSize = _ref2.gridSize,
      gridSize = _ref2$gridSize === void 0 ? 30 : _ref2$gridSize;
  return {
    backgroundColor: backgroundColor,
    backgroundRepeat: "repeat",
    backgroundSize: gridSize + "px " + gridSize + "px",
...
function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    var _props = this.props,
        ...
        backgroundColor = _props$backgroundColo === void 0 ? "#434343" : _props$backgroundColo,
        className = _props.className,
        gridColor = _props.gridColor,
        gridRef = _props.gridRef,
        gridSize = _props.gridSize,
        gridType = _props.gridType,
        style = _props.style,
        props = _objectWithoutProperties(_props, ["backgroundColor", "className", "gridColor", "gridRef", "gridSize", "gridType", "style"]);
    return React.createElement("div", _extends({
      className: className,
      style: _extends({}, styles[gridType] ? styles[gridType]({
        backgroundColor: backgroundColor,
        gridColor: gridColor,
        gridSize: gridSize
      }) : {
...
var enhancedThemeable = function enhancedThemeable(defaultStyleName, theme, className, style) {
  ...
  return function (key) {
    ...
    if (style) {
      if (props.style) {
        props.style = _extends({}, props.style, style);
      } else {
        props.style = style;
      }
    }
    ...
    if (moreStyle) {
      props.style = _extends({}, props.style, moreStyle);
    }
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inheritsLoose(ScrollBox, _React$PureComponent);
  ...
  _proto.scrollDelta = function scrollDelta(e, dx, dy) {
    this.scroll(e, this.scrollElement.scrollLeft + dx, this.scrollElement.scrollTop + dy);
  };
  ...
  _proto.render = function render() {
    ...
    var C = render ? render(p) : component ? React.createElement(component, p) : React.createElement("div", {
      ref: ref,
      style: sty
    }, children);
    var t = enhancedThemeable("scrollBox", theme, className, style);
    return React.createElement("div", _extends({
      id: id,
      onWheel: function onWheel(e) {
        e.preventDefault();

        _this2.scrollDelta(e, e.deltaX, e.deltaY);
      },
      ref: function ref(e) {
...
var Handle = function Handle(_ref) {
  var children = _ref.children,
      ...
      style = _ref.style,
      _ref$theme = _ref.theme,
      theme = _ref$theme === void 0 ? Handle.defaultTheme : _ref$theme;

  var startConnect = function startConnect(e) {
    if (onConnectionStart) {
      onConnectionStart(e);
    }
  };

  var endConnect = function endConnect(e) {
    if (onConnect) {
      onConnect(e);
    }
  };

  var t = enhancedThemeable("handle", theme, className, style);
  return React.createElement("div", _extends({
    onClick: onClick,
...
var Attribute = function Attribute(_ref) {
  var children = _ref.children,
      ...
      contentTheme = _ref.contentTheme,
      className = _ref.className,
      data = _ref.data,
      ...
      style = _ref.style,
      _ref$theme = _ref.theme,
      theme = _ref$theme === void 0 ? Attribute.defaultTheme : _ref$theme;
  var t = enhancedThemeable("attribute", theme, className, style);
  var dr = draggable === true || typeof children === "string";
  var stopPropagation = dr ? undefined : function (e) {
    e.stopPropagation();
  };
  var sn = ["attribute", input && output ? "inputOutputAttribute" : input ? "inputAttribute" : output ? "outputAttribute" : "plainAttribute"].concat(isNodeAttribute ? ["nodeAttribute"] : [], single ? ["singleAttribute"] : []);
  var contentProps = {
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inheritsLoose(AttributeList, _React$PureComponent);

  function AttributeList() {
    return _React$PureComponent.apply(this, arguments) || this;
  }

  var _proto = AttributeList.prototype;

  _proto.handleEvent = function handleEvent(propName, e, _ref) {
    var a = _ref.a,
        i = _ref.i,
        type = _ref.type;
  ...
  _proto.handleConnectionStart = function handleConnectionStart() {
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    this.handleEvent.apply(this, ["onConnectionStart"].concat(args));
  };

  _proto.handleConnect = function handleConnect() {
    for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
      args[_key2] = arguments[_key2];
    }

    this.handleEvent.apply(this, ["onConnect"].concat(args));
  };
  ...
  _proto.setHandleRef = function setHandleRef(a, type, e) {
    var handleRefs = this.props.handleRefs;
  ...
  _proto.render = function render() {
    ...
    var _props = this.props,
        ...
        theme = _props.theme;
    return React.createElement(React.Fragment, null, attributes && attributes.map(function (a, i) {
...
AttributeList.defaultTheme = _extends({}, Attribute.defaultTheme);
AttributeList.attributePropTypeShape = attributePropTypeShape;
...
function E(a){for(var b=arguments.length-1,c="Minified React error #"+a+"; visit http://facebook.github.io/react/docs/error-decoder.html?invariant\x3d"+a,d=0;d<b;d++)c+="\x26args[]\x3d"+encodeURIComponent(arguments[d+1]);b=Error(c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings.");b.name="Invariant Violation";b.framesToPop=1;throw b;}React?void 0:E("227");
...
var Da={Properties:{allowFullScreen:K,async:K,autoFocus:K,autoPlay:K,capture:Ba,checked:ya|K,cols:Aa,contentEditable:Ca,controls:K,"default":K,defer:K,disabled:K,download:Ba,draggable:Ca,formNoValidate:K,hidden:K,loop:K,multiple:ya|K,muted:ya|K,noValidate:K,open:K,playsInline:K,readOnly:K,required:K,reversed:K,rows:Aa,rowSpan:za,
...
var M={xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace"};
var Ga={Properties:{autoReverse:Ea,externalResourcesRequired:Ea,preserveAlpha:Ea},DOMAttributeNames:{autoReverse:"autoReverse",externalResourcesRequired:"externalResourcesRequired",preserveAlpha:"preserveAlpha"},DOMAttributeNamespaces:{xlinkActuate:M.xlink,xlinkArcrole:M.xlink,xlinkHref:M.xlink,xlinkRole:M.xlink,xlinkShow:M.xlink,xlinkTitle:M.xlink,xlinkType:M.xlink,
...
function Ka(){if(P._hasRethrowError){var a=P._rethrowError;P._rethrowError=null;P._hasRethrowError=!1;throw a;}}var La=null; var Ma={};
function Na(){if(La)for(var a in Ma){var b=Ma[a],c=La.indexOf(a);-1<c?void 0:E("96",a);if(!Oa[c]){b.extractEvents?void 0:E("97",a);Oa[c]=b;c=b.eventTypes;for(var d in c){var e=void 0;var f=c[d],g=b,h=d;Pa.hasOwnProperty(h)?E("99",h):void 0;Pa[h]=f;var k=f.phasedRegistrationNames;if(k){for(e in k)k.hasOwnProperty(e)&&Qa(k[e],g,h);e=!0;}else f.registrationName?(Qa(f.registrationName,g,h), e=!0):e=!1;e?void 0:E("98",d,a);}}}}
function Qa(a,b,c){Ra[a]?E("100",a):void 0;Ra[a]=b;Sa[a]=b.eventTypes[c].dependencies;}var Oa=[]; var Pa={}; var Ra={}; var Sa={};function Ta(a){La?E("101"):void 0;La=Array.prototype.slice.call(a);Na();}function Ua(a){var b=!1,c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];Ma.hasOwnProperty(c)&&Ma[c]===d||(Ma[c]?E("102",c):void 0, Ma[c]=d, b=!0);}b&&Na();}
...
var Wa=null;
var Xa=null;
var Ya=null;function Za(a,b,c,d){b=a.type||"unknown-event";a.currentTarget=Ya(d);P.invokeGuardedCallbackAndCatchFirstError(b,c,void 0,a);a.currentTarget=null;}
...
return c}function jb(a,b,c,d){for(var e,f=0;f<Oa.length;f++){var g=Oa[f];g&&(g=g.extractEvents(a,b,c,d))&&(e=$a(e,g));}return e}function kb(a){a&&(bb=$a(bb,a));}function lb(a){var b=bb;bb=null;b&&(a?ab(b,db):ab(b,gb), bb?E("95"):void 0, P.rethrowCaughtError());}var mb=Object.freeze({injection:hb,getListener:ib,extractEvents:jb,enqueueEvents:kb,processEventQueue:lb}); var nb=Math.random().toString(36).slice(2); var Q="__reactInternalInstance$"+nb; var ob="__reactEventHandlers$"+nb;
...
var Db=null;function Eb(){!Db&&ExecutionEnvironment_1.canUseDOM&&(Db="textContent"in document.documentElement?"textContent":"innerText");return Db}var S={_root:null,_startText:null,_fallbackText:null};
...
var jc=null;
var kc=null;
var lc=null;function mc(a){if(a=Xa(a)){jc&&"function"===typeof jc.restoreControlledState?void 0:E("194");var b=Wa(a.stateNode);jc.restoreControlledState(a.stateNode,a.type,b);}}var nc={injectFiberControlledHostComponent:function(a){jc=a;}};function oc(a){kc?lc?lc.push(a):lc=[a]:kc=a;}
...
function rd(a){var b=a.targetInst;do{if(!b){a.ancestors.push(b);break}var c;for(c=b;c["return"];)c=c["return"];c=3!==c.tag?null:c.stateNode.containerInfo;if(!c)break;a.ancestors.push(b);b=pb(c);}while(b);for(c=0;c<a.ancestors.length;c++)b=a.ancestors[c], sd(a.topLevelType,b,a.nativeEvent,wc(a.nativeEvent));}var td=!0; var sd=void 0;function ud(a){td=!!a;}function U(a,b,c){return c?EventListener_1.listen(c,b,vd.bind(null,a)):null}function wd(a,b,c){return c?EventListener_1.capture(c,b,vd.bind(null,a)):null}
...
function ce(a,b,c,d){return T.call(this,a,b,c,d)}fd.augmentClass(ce,{deltaX:function(a){return"deltaX"in a?a.deltaX:"wheelDeltaX"in a?-a.wheelDeltaX:0},deltaY:function(a){return"deltaY"in a?a.deltaY:"wheelDeltaY"in a?-a.wheelDeltaY:"wheelDelta"in a?-a.wheelDelta:0},deltaZ:null,deltaMode:null});var de={}; var ee={};
...
1;"object"===typeof d&&null!==d&&"function"===typeof d.render?(b.tag=2, e=qe(b), w(b,d), A(b,c), b=h(a,b,!0,e)):(b.tag=1, f(a,b,d), b.memoizedProps=e, b=b.child);return b;case 1:a:{e=b.type;c=b.pendingProps;d=b.memoizedProps;if(X.current)null===c&&(c=d);else if(null===c||d===c){b=q(a,b);break a}d=ke(b);d=me(b,d);e=e(c,d);b.effectTag|=1;f(a,b,e);b.memoizedProps=c;b=b.child;}return b;case 2:return e=qe(b), d=void 0, null===a?b.stateNode?E("153"):(m(b,b.pendingProps), A(b,c), d=!0):d=Ob(a,b,c), h(a,b,d,e);case 3:return k(b), e=b.updateQueue, null!==e?(d=b.memoizedState, e=Je(a,b,e,null,null,c), d===e?(N(), b=q(a,b)):(d=e.element, r=b.stateNode, (null===a||null===a.child)&&r.hydrate&&L(b)?(b.effectTag|=2, b.child=cf(b,null,d,c)):(N(), f(a,b,d)), b.memoizedState=e, b=b.child)):(N(), b=q(a,b)), b;case 5:G(b);null===a&&J(b);e=b.type;var n=b.memoizedProps;d=b.pendingProps;null===d&&(d=n, null===d?E("154"):void 0);r=null!==a?a.memoizedProps:null;X.current||null!==d&&n!==d?(n=d.children, y(e,d)?n=null:r&&y(e,r)&&(b.effectTag|=16), g(a,b), 2147483647!==c&&!u&&z(e,d)?(b.expirationTime=2147483647, b=null):(f(a,b,n), b.memoizedProps=d, b=b.child)):b=q(a,b);return b;case 6:return null===a&&J(b), a=b.pendingProps, null===a&&(a=b.memoizedProps), b.memoizedProps=a, null;case 8:b.tag=7;case 7:e=b.pendingProps;if(X.current)null===e&&(e=a&&a.memoizedProps, null===e?E("154"):void 0);else if(null===e||b.memoizedProps===e)e=b.memoizedProps;d=e.children;b.stateNode=null===a?cf(b,b.stateNode,d,c):bf(b,b.stateNode,d,c);b.memoizedProps=e;return b.stateNode;
...
function Tf(a,b){var c=b.value;a._wrapperState={initialValue:null!=c?c:b.defaultValue,wasMultiple:!!b.multiple};}function Uf(a,b){null!=b.dangerouslySetInnerHTML?E("91"):void 0;return objectAssign$2({},b,{value:void 0,defaultValue:void 0,children:""+a._wrapperState.initialValue})}function Vf(a,b){var c=b.value;null==c&&(c=b.defaultValue, b=b.children, null!=b&&(null!=c?E("92"):void 0, Array.isArray(b)&&(1>=b.length?void 0:E("93"), b=b[0]), c=""+b), null==c&&(c=""));a._wrapperState={initialValue:""+c};}
...
lg(d,"onChange");break;case "option":f=Rf(a,c);break;case "select":Tf(a,c);f=objectAssign$2({},c,{value:void 0});U("topInvalid","invalid",a);lg(d,"onChange");break;case "textarea":Vf(a,c);f=Uf(a,c);U("topInvalid","invalid",a);lg(d,"onChange");break;default:f=c;}hg(b,f,kg);var g=f,h;for(h in g)if(g.hasOwnProperty(h)){var k=g[h];"style"===h?fg(a,k,kg):"dangerouslySetInnerHTML"===h?(k=k?k.__html:void 0, null!=k&&bg(a,k)):"children"===h?"string"===typeof k?("textarea"!==b||""!==k)&&cg(a,k):"number"===typeof k&&cg(a,
...
!React$$2 ? invariant(false, 'ReactDOM was loaded before React. Make sure you load the React package before loading ReactDOM.') : void 0;
...
var ReactInternals = React$$2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
...
var Draggable = unwrapExports(reactDraggable);

var NodeAttribute = function NodeAttribute(_ref) {
  var className = _ref.className,
      data = _ref.data,
      style = _ref.style,
      _ref$theme = _ref.theme,
...
var defaultTheme = _extends({}, Handle.defaultTheme, Attribute.defaultTheme, {
  attribute: _extends({}, Attribute.defaultTheme.attribute),
  nodeAttribute: {
...
function (_React$PureComponent) {
  ...
  _proto.handleConnectionStart = function handleConnectionStart(e) {
    e.preventDefault();
    e.stopPropagation();
  ...
  _proto.handleConnect = function handleConnect(e) {
    e.preventDefault();
    e.stopPropagation();
  ...
  _proto.render = function render() {
    ...
    var _props = this.props,
        ...
        _props$draggable = _props.draggable,
    ...
    var dna = nodeAttribute && (!nodeAttribute.children || !nodeAttribute.component || !nodeAttribute.render) ? NodeAttribute : undefined;
...
Node.defaultTheme = defaultTheme;

var Editor =
/*#__PURE__*/
function (_React$PureComponent) {
  _inheritsLoose(Editor, _React$PureComponent);
  ...
  function Editor() {
    ...
    return (_temp = _this = _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args)) || this, _this.state = {
      ...
      connectingEdge: null,
      rendered: false
    }, _this.scrollElement = null, _this.workspaceElement = null, _this.handleRefs = new Map(), _this.stopDragging = function () {
  ...
  _proto.handleConnectionStart = function handleConnectionStart(e, _ref, n) {
    var attribute = _ref.attribute,
        type = _ref.type;
    if (this.state.connecting) return;
    var tr = e.target.getBoundingClientRect();
    var pr = this.workspaceElement.getBoundingClientRect();
    var x = tr.left - pr.left + tr.width / 2;
    var y = tr.top - pr.top + tr.height / 2;
    this.setState({
      connecting: {
        node: n,
        attribute: attribute,
  ...
  _proto.handleHandleClick = function handleHandleClick(e, a, n, i) {
  ...
  _proto.getHandleElement = function getHandleElement(edge) {
    ...
    var ta = this.handleRefs.get(edge.to.node);
  ...
  _proto.render = function render() {
    ...
    var _props = this.props,
        ...
        edgeShadowRadius = _props$appearance.edgeShadowRadius,
        edgeStrokeColor = _props$appearance.edgeStrokeColor,
        edgeStrokeWidth = _props$appearance.edgeStrokeWidth,
        gridBackgroundColor = _props$appearance.gridBackgroundColor,
        gridColor = _props$appearance.gridColor,
        gridSize = _props$appearance.gridSize,
        gridType = _props$appearance.gridType,
        className = _props.className,
        data = _props.data,
        id = _props.id,
    ...
    return React.createElement(ScrollBox, {
      ...
      if (!elem) return null;
      var fromRect = elem.from.getBoundingClientRect();
      var toRect = elem.to.getBoundingClientRect();
      var x1 = fromRect.left - workspaceRect.left + fromRect.width / 2;
      var y1 = fromRect.top - workspaceRect.top + fromRect.height / 2;
      var x2 = toRect.left - workspaceRect.left + toRect.width / 2;
      var y2 = toRect.top - workspaceRect.top + toRect.height / 2;
      var key = e.from.node + "_" + e.from.attribute + "_" + e.to.node + "_" + e.to.attribute;
      ...
      return React.createElement(Node, {
        attributes: nt.attributes.map(function (a) {
          return _extends({}, a, {
            ...
            outputConnected: data.edges && data.edges.some(function (e) {
              return e.from.node === n.id && e.from.attribute === a.id;
            })
          });
        }),
        ...
        onHandleClick: function onHandleClick(e, a) {
          return _this2.handleHandleClick(e, a, n, i);
        },
        position: {
          x: n.x,
          y: n.y
...
export { Grid, ScrollBox, Edge, Handle, Attribute, AttributeList, Node, NodeAttribute, Editor };
